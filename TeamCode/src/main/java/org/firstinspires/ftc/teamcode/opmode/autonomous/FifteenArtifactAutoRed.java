...
public class FifteenArtifactAutoRed extends AutonomousBase {
    ...
    protected AutonomousStage[] buildStageSequence() {
        ...
        return new AutonomousStage[]{
            ...
            new AutonomousStage(
                follower.pathBuilder().addPath(new BezierPoint(autoPaths.shootFirstRow.endPose()))
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build()
                , Robot.RobotState.SHOOT
            ),
            ...
            new AutonomousStage(
                follower.pathBuilder().addPath(new BezierPoint(autoPaths.shootSecondRow.endPose()))
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build()
                , Robot.RobotState.SHOOT
            ),
            ...
            new AutonomousStage(
                follower.pathBuilder()
                    .addPath(new BezierPoint(autoPaths.firstGateCycleShoot.endPose()))
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build()
                , Robot.RobotState.SHOOT
            ),
            ...
            new AutonomousStage(
                follower.pathBuilder()
                    .addPath(new BezierPoint(autoPaths.secondGateCycleShoot.endPose()))
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build()
                , Robot.RobotState.SHOOT
            ),
