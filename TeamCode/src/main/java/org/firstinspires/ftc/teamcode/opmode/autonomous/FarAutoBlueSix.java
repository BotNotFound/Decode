    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            intakeArtifacts = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(137.8, 23.25).mirror(), new Pose(141.336, 2.164).mirror())
                    )
            ...
            shootArtifacts = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(141.336, 2.164).mirror(), new Pose(90.562, 16.980).mirror())
                    )
            ...
            leaveLaunchZone = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(90.562, 16.980).mirror(), new Pose(105.711, 10.155).mirror())
                    )
