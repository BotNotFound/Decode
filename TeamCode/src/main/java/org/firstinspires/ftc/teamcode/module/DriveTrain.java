...
public class DriveTrain {
    public static final String FRONT_RIGHT_DRIVE_MOTOR_NAME = "Front Right Drive Motor";
    public static final String FRONT_LEFT_DRIVE_MOTOR_NAME = "Front Left Drive Motor";
    public static final String BACK_RIGHT_DRIVE_MOTOR_NAME = "Back Right Drive Motor";
    public static final String BACK_LEFT_DRIVE_MOTOR_NAME = "Back Left Drive Motor";
