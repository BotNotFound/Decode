...
public class TwentyOneArtifactRed extends AutonomousBase{
    ...
    protected AutonomousStage[] buildStageSequence() {
        ...
        return new AutonomousStage[] {
                ...
                new AutonomousStage(
                        follower.pathBuilder().addPath(new BezierPoint(autoPath.shootPreloadArtifacts.endPose()))
                        .setConstantHeadingInterpolation(Math.toRadians(44)).build(),
                        Robot.RobotState.SHOOT),
                new AutonomousStage(autoPath.intake2ndRowArtifacts, Robot.RobotState.INTAKE),
                new AutonomousStage(autoPath.shoot2ndRowArtifacts, Robot.RobotState.PRE_SHOOT), new AutonomousStage(
                ...
                new AutonomousStage(
                        follower.pathBuilder().addPath(new BezierPoint(autoPath.firstCycleGateIntake.endPose()))
                ...
                new AutonomousStage(
                        follower.pathBuilder().addPath(new BezierPoint(autoPath.firstCycleGateIntakeShoot.endPose()))
                        .setConstantHeadingInterpolation(Math.toRadians(-45))
                        .build(),
                        Robot.RobotState.SHOOT
                ),
                ...
                new AutonomousStage(
                        follower.pathBuilder().addPath(new BezierPoint(autoPath.secondCycleGateIntake.endPose()))
                ...
                new AutonomousStage(
                        follower.pathBuilder().addPath(new BezierPoint(autoPath.secondCycleGateIntakeShoot.endPose()))
                                .setConstantHeadingInterpolation(Math.toRadians(-45))
                                .build(),
                        Robot.RobotState.SHOOT
                ),
                ...
                new AutonomousStage(
                        follower.pathBuilder().addPath(new BezierPoint(autoPath.firstRowArtifactsShoot.endPose()))
                        ...
                        new AutonomousStage(
                                follower.pathBuilder().addPath(new BezierPoint(autoPath.thirdRowArtifactIntakeShoot.endPose()))
