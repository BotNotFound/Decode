    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            intakeFirstRow = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(101.000, 84.000), new Pose(140.100, 84.000))
                    )
            ...
            hitGate = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(140.100, 84.000),
                                    new Pose(109.722, 82.838),
                                    new Pose(135.900, 71.244),
                                    new Pose(135.900, 71.244)
                            )
                    )
            ...
            intakeSecondRow = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(101.800, 59.986), new Pose(140.975, 59.818))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();
            ...
            intakeThirdRow = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(100.400, 35.622), new Pose(140.975, 35.622))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                    .build();
